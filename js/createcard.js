...
function createcards(amount) {
    while (amount>0) {
        ...
        // Make card
        $(".holder").append("<div class=\"card" + cardNumber + "\"></div>");
        ...
        $(".card" + cardNumber + ".number").text( numbers[countNumbers] );
        ...
        $(".card" + cardNumber + ".top-symbol").text( symbols[countSymbols] );
        $(".card" + cardNumber + ".bottom-symbol").text( symbols[countSymbols] );
...
var changeSuitImage = function() {
    ...
    // Create picture div
    $(".card" + cardNumber).append("<div class=\"symbol center-symbol\"><img src=\"images/" + suit + numbers[countNumbers] + ".png\"/></div>");
